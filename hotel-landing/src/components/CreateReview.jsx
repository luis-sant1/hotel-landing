// Este componente es para crear nuevos testimonios de los clientes, tiene los datos para el nombre de usuario y el tertimonio, deje los errores y las validaciones del formulario validadas por si las necesitas mas adelante, pero si no las nacesitas las borro y listo.
        ...
        <div className='h-full '>
            <div className='mr-auto ml-auto w-11/12 md:w-7/12 lg:w-3/12 '>
                <form className='grid grid-cols-1 justify-center h-full '>
                    <label htmlFor="" className='font-light pt-10 mt-[40px]'>Nombre de usuario</label>
                    <div className='pt-1'>
                        <input type="text"
                    ...
                    <label htmlFor="" className='font-light pt-2'>Testimonio del cliente</label>
                    <div className='pt-1'>
                        <input type="text"
