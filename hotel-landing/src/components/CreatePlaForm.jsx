// Este componente es para crear nuevas trajetas de nuestras playas, tiene los datos para el titulo, la descripción de la trajeta, el link a que redirecciona y para la imagen de fondo, deje los errores y las validaciones del formulario validadas por si las necesitas mas adelante, pero si no las nacesitas las borro y listo.
export default function CreatePlaForm() {
